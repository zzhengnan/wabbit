...
def test_declaration():
    assert tokenize('var x;') == [
        Token('VAR', 'var'),
        Token('NAME', 'x'),
        Token('SEMI', ';'),
    ]
    assert tokenize('var x int;') == [
        Token('VAR', 'var'),
        Token('NAME', 'x'),
        Token('INTEGER_TYPE', 'int'),
        Token('SEMI', ';'),
    ]
    assert tokenize('var x float;') == [
        Token('VAR', 'var'),
        Token('NAME', 'x'),
