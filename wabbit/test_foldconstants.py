...
class TestFoldExpressionMixedAddAndMul:
    ...
    def test_nested_with_name(self):
        # (3 * 4) + x * (1 + 2) -> 12 + x * 3
        expr = Add(Mul(Integer(3), Integer(4)), Mul(Name('x'), Add(Integer(1), Integer(2))))
...
class TestFoldExpressionFuncCall:
    ...
    def test_nested_integer_literals(self):
        # foo((3 * 4) + (1 + 2)) -> foo(15)
        expr = Call(Name('foo'), Add(Mul(Integer(3), Integer(4)), Add(Integer(1), Integer(2))))
...
class TestFoldStatement():
    def test_If(self):
        ...
        stmt = If(
            Eq(Name('n'), Integer(5)),
            [Variable(Name('x'), Add(Mul(Integer(3), Integer(100)), Integer(1))), Print(Name('x'))],
    ...
    def test_Func(self):
        ...
        #     return 13;
        # }
        expected = Func(Name('square'), Name('x'), [
...
def test_control():
    ...
    prog = Program([
        ...
        While(Lt(Name('n'), Integer(10)), [
            ...
            Assignment(Name('n'), Add(Integer(100), Mul(Integer(2), Integer(8)))),
        ])
    ])
...
def test_func():
    ...
    prog = Program([
        ...
        Variable(Name('result'), Add(Call(Name('square'), Integer(4)), Mul(Integer(3), Integer(4)))),
    ...
    expected = Program([
        ...
        Variable(Name('result'), Add(Call(Name('square'), Integer(4)), Integer(12))),
        Print(Integer(300)),
    ])
